...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div data-aos="zoom-in" className="w-[50%] m-3 max-md:w-[80%] max-sm:w-[100%] max-md:mx-auto">
        <img
          src="./school.png"
          alt="school"
      ...
      <div data-aos="zoom-in" className="w-[50%]  max-md:w-[80%] max-md:mx-auto max-sm:w-[100%]">
